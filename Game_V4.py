...
def main(level):
    scale = (55*.85, 92*.85)  # for normal player
    enemy_scale = (70 * 2.2, 92 * 0.8)
    # scale = (60,92) # with sword
    player = Player(100, 100, 'player', scale)
    # enemy = Player(500,100,'enemy',scale,all_animations = ['Idle','Die'],max_health = 50 )
    enemy_1 = Enemy(500, 100, 'player2', enemy_scale, all_animations=['Idle', 'Die'], max_health=100)
    enemy_2 = Enemy(700, 100, 'player2', enemy_scale, all_animations=['Idle', 'Die'], max_health=100)
    enemy_3 = Enemy(400, 100, 'player2', enemy_scale, all_animations=['Idle', 'Die'], max_health=100)
    # sprite groups
    arrows = []
